...
C36_CATALOGUE_PHRASES = {
    "en": ("has nothing to check", "classifies every catalogue as unsigned",
           ...
           "is signed; the catalogue is not"),
