> **Traducción de la comunidad, sincronizada por última vez el 2026-04-17.** La documentación en inglés es la autoritativa y ha cambiado desde entonces. Consulta [docs/en](../../en/README.md).
>
...
Cree plugins para [Astra](https://github.com/mihailinl/AstraPlugins) — el asistente digital con inteligencia artificial — en Rust, Python o TypeScript.
