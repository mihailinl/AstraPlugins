> **社区翻译，最后同步于 2026-04-17。** 英文文档具有权威性，且此后已发生变更。请参阅 [docs/en](../../en/README.md)。
>
...
使用 Rust、Python 或 TypeScript 为 [Astra](https://github.com/mihailinl/AstraPlugins)（AI 驱动的数字助手）构建插件。
