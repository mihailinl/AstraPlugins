> **Aún sin traducir.** Esta página solo está disponible en inglés por ahora. Si hay alguna discrepancia, [`docs/en`](../../en/3-reference/localisation.md) es la referencia autorizada.
>
