...
| [Instalar la CLI](install-cli.md) | `astra-plugin` no está en crates.io y todavía no tiene binarios precompilados; así se consigue de todos modos, con honestidad |
