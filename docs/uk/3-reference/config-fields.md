...
Кожен тип несе ще й **`icon_svg`** — цілу SVG-розмітку, а не рядок шляху, —
гліф, який крок носить на полотні, у палітрі та в заголовку своїх налаштувань.
Задайте `viewBox` і не вказуйте `width`/`height`, бо розмір обирає Astra, а ці
три поверхні різні, та малюйте через `currentColor`, щоб гліф ішов за тим, чим
кожна поверхня підфарбовує свої піктограми. Розмітка очищується перед
відмальовуванням: скрипти, обробники подій і зовнішні посилання вирізаються, а
не відхиляються. Лишіть її порожньою — крок усе одно намалюється, відкотившись
до власної піктограми плагіна, а потім до загальної позначки плагіна. Отже,
піктограма відрізняє ваш крок від чужих, а не робить його видимим.
