...
`astra-plugin-sdk` **0.7.1 — версія, яку описує ця сторінка**, і та, що
...
**Гліф, який носить крок.** `iconSvg` у дії або тригера — це те, що користувач
бачить на полотні, у палітрі та в заголовку налаштувань кроку. Передавайте цілу
