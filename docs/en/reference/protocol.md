...
Protocol generation **1**. 10 services, 159 RPCs. Source: [`proto/plugin.proto`](../../../proto/plugin.proto), a generated slice of Astra's `astra.proto` (`source-sha256: 99a86955a228076a…`), pinned by [`proto/PROTO_VERSION`](../../../proto/PROTO_VERSION) at `sha256:3f6833294d4db990…`. Every vendored copy in the three SDKs has that same hash; `tools/check-proto.sh` is what says so.
