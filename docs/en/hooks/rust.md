...
Protocol **1**. Every hook the Rust SDK can bind, and whether it does. Generated from [`spec/hooks.yaml`](../../../spec/hooks.yaml); the cross-language view is [`parity.md`](../parity.md).
