...
- **`trust.json`, the served catalogue and the withdrawal list on Pages are
  signed.** The root ceremony ran on
  ...
  Pages serves is signed too, since astra-registry commit `@FLAG7@`, so
